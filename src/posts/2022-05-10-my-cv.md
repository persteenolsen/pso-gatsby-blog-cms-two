...
I am a Software Developer with passion for AI, ML, DL, RAG, Python, Django, FastAPI, Wagtail CMS, C#, .NET, Umbraco CMS, Java, Node.js, JavaScript, TypeScript, Next.js, React, Vue.js, Angular, Webpack and Vite as well as other programming languages, tools and DevOps
...
* C#, .NET, Python, Java, Node.js, JavaScript, TypeScript, Next.js, React, Nuxt, Vue.js and Angular
* MSSQL, MySQL, PostgreSQL and MongoDB 
