...
Python FastAPI with JWT Auth and OpenAPI / Swagger serving a RAG Application using LLM by Groq - hosted at Vercel Cloud using Serverless Functions and implementing DevOps by GitHub + Vercel
